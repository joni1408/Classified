...
public class ServerRequest {
	...
	public static void postRequest(final String url, final JSONObject json,
			final String uid, final ResponseListener r, final int rid) {
		System.out.println("");
	...
	private static String getString2(InputStream in) {
		/*
		 * int c = -1; StringBuffer r = new StringBuffer();
		 * 
		 * try { while ((c = in.read()) != -1) r.append((char) c);
		 * 
		 * return r.toString(); } catch (Exception e) { }
		 */
